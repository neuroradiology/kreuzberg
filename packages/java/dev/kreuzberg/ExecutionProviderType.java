...
public enum ExecutionProviderType {
    ...
    public static ExecutionProviderType fromValue(final String value) {
        ...
        // This enum has variant(s) excluded from binding (marked with #[cfg_attr(alef, alef(skip))]):        throw new IllegalArgumentException("Unknown ExecutionProviderType value: " + value);
    }
