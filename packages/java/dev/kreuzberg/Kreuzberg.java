...
public final class Kreuzberg {
    ...
    public static String summarizeWithLlm(
        ...
        return KreuzbergRs.summarizeWithLlm(text, llmConfig, maxTokens);
    }

    public static String summarizeWithLlm(final String text, final LlmConfig llmConfig) throws KreuzbergRsException {
        return KreuzbergRs.summarizeWithLlm(text, llmConfig, 0);
    }
    ...
    public static String extractRegionWithVlmUsage(
        ...
        java.util.Objects.requireNonNull(regionKind, "regionKind must not be null");
        java.util.Objects.requireNonNull(llmConfig, "llmConfig must not be null");
        return KreuzbergRs.extractRegionWithVlmUsage(imageBytes, imageMime, regionKind, llmConfig, customPrompt);
    }
    ...
    public static String extractRegionWithVlmUsage(
        ...
        return KreuzbergRs.extractRegionWithVlmUsage(imageBytes, imageMime, regionKind, llmConfig, null);
    }
    ...
    public static String completeWithJsonSchema(
        ...
        java.util.Objects.requireNonNull(schemaName, "schemaName must not be null");
        ...
        return KreuzbergRs.completeWithJsonSchema(llmConfig, prompt, schemaName, schema, source);
    }
    ...
    public static String completeText(final LlmConfig llmConfig, final String prompt, final String source) throws KreuzbergRsException {
        ...
        java.util.Objects.requireNonNull(prompt, "prompt must not be null");
        java.util.Objects.requireNonNull(source, "source must not be null");
        return KreuzbergRs.completeText(llmConfig, prompt, source);
    }
