...
// alef:hash:0df6a2ff35cf4dd0c528036e5f7d1a359b7b076117799ad417af08cf184c608d
...
public class HtmlMetadataBuilder {
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("canonical_url")
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("base_href")
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("text_direction")
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("open_graph")
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("twitter_card")
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("meta_tags")
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("structured_data")
