...
class KreuzbergApi
{
    ...
    public static function summarizeWithLlm(string $text, \Kreuzberg\LlmConfig $llm_config, ?int $max_tokens = null): string { throw new \RuntimeException('Not implemented.'); }
    ...
    public static function extractRegionWithVlmUsage(string $image_bytes, string $image_mime, \Kreuzberg\RegionKind $region_kind, \Kreuzberg\LlmConfig $llm_config, ?string $custom_prompt = null): string { throw new \RuntimeException('Not implemented.'); }
    public static function completeWithJsonSchema(\Kreuzberg\LlmConfig $llm_config, string $prompt, string $schema_name, string $schema, string $source): string { throw new \RuntimeException('Not implemented.'); }
    public static function completeText(\Kreuzberg\LlmConfig $llm_config, string $prompt, string $source): string { throw new \RuntimeException('Not implemented.'); }
    /**
