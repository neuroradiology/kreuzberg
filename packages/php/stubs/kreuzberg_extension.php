...
namespace Kreuzberg {
    ...
    class KreuzbergApi
    {
         ...
         */
        public static function detectQrCodes(string $image_bytes, ?string $_format_hint = null): array
        {
            throw new \RuntimeException('Not implemented.');
        }
        ...
        public static function downloadModel(string $name, ?string $cache_dir = null): string
        {
            throw new \RuntimeException('Not implemented.');
        }
         ...
         * @return array<\Kreuzberg\PatternMatch>
         */
        public static function scanText(string $text, array $categories): array
        {
            throw new \RuntimeException('Not implemented.');
        }
        public static function applyStrategy(\Kreuzberg\RedactionStrategy $strategy, string $original, \Kreuzberg\PiiCategory $category, \Kreuzberg\TokenCounter $counter): string
        {
            throw new \RuntimeException('Not implemented.');
        }
        public static function summarize(string $text, ?string $language = null, ?int $max_tokens = null): ?string
        {
            throw new \RuntimeException('Not implemented.');
        }
        ...
        public static function compare(\Kreuzberg\ExtractionResult $a, \Kreuzberg\ExtractionResult $b, \Kreuzberg\DiffOptions $opts): \Kreuzberg\ExtractionDiff
        {
            throw new \RuntimeException('Not implemented.');
        }
        public static function extractRegionWithVlm(string $image_bytes, string $image_mime, \Kreuzberg\RegionKind $region_kind, \Kreuzberg\LlmConfig $llm_config, ?string $custom_prompt = null): string
        {
            throw new \RuntimeException('Not implemented.');
        }
        /**
