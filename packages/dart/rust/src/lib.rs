...
impl From<xberg::UrlExtractionConfig> for UrlExtractionConfig {
    fn from(v: xberg::UrlExtractionConfig) -> Self {
        UrlExtractionConfig {
            ...
            request_timeout_secs: v.request_timeout_secs.map(|x| x as _),
            download_documents: v.download_documents as _,
            document_max_size_bytes: v.document_max_size_bytes.map(|x| x as _),
            allowed_file_types: v.allowed_file_types.into_iter().map(|s| s.into()).collect::<Vec<_>>(),
...
impl From<UrlExtractionConfig> for xberg::UrlExtractionConfig {
    fn from(v: UrlExtractionConfig) -> Self {
        xberg::UrlExtractionConfig {
            ...
            download_documents: v.download_documents as _,
            document_max_size_bytes: v.document_max_size_bytes.map(|x| x as _),
            allowed_file_types: v.allowed_file_types.into_iter().map(Into::into).collect(),
            follow_document_urls: v.follow_document_urls as _,
            document_url_depth: v.document_url_depth.map(|x| x as _),
...
pub async fn extract_bytes(
    ...
    xberg::core::extractor::extract_bytes(&content, &mime_type, &xberg::ExtractionConfig::from(config))
        .await
...
pub async fn extract_file(
    ...
    xberg::core::extractor::extract_file(
...
pub fn extract_file_sync(
    ...
    xberg::core::extractor::extract_file_sync(
        std::path::PathBuf::from(path),
        mime_type.as_deref(),
        &xberg::ExtractionConfig::from(config),
    )
...
pub fn extract_bytes_sync(
    ...
    xberg::core::extractor::extract_bytes_sync(&content, &mime_type, &xberg::ExtractionConfig::from(config))
        .map(ExtractionResult::from)
        .map_err(|e| e.to_string())
}
...
pub fn batch_extract_files_sync(
    ...
    xberg::core::extractor::batch_extract_files_sync(
...
pub fn batch_extract_bytes_sync(
    ...
    xberg::core::extractor::batch_extract_bytes_sync(
...
pub async fn batch_extract_files(
    ...
    xberg::core::extractor::batch_extract_files(
        items.into_iter().map(xberg::BatchFileItem::from).collect::<Vec<_>>(),
        &xberg::ExtractionConfig::from(config),
    )
    .await
...
pub async fn batch_extract_bytes(
    ...
    xberg::core::extractor::batch_extract_bytes(
        items.into_iter().map(xberg::BatchBytesItem::from).collect::<Vec<_>>(),
        &xberg::ExtractionConfig::from(config),
    )
    .await
