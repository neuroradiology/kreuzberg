...
mod ffi {
    ...
    extern "Rust" {
        ...
        #[swift_bridge(swift_name = "requestTimeoutSecs")]
        fn request_timeout_secs(&self) -> Option<u64>;
        #[swift_bridge(swift_name = "downloadDocuments")]
        fn download_documents(&self) -> bool;
        #[swift_bridge(swift_name = "documentMaxSizeBytes")]
        fn document_max_size_bytes(&self) -> Option<u64>;
        #[swift_bridge(swift_name = "allowedFileTypes")]
        fn allowed_file_types(&self) -> Vec<String>;
...
impl UrlExtractionConfig {
    pub fn new(
        ...
        __target.request_timeout_secs = request_timeout_secs;
        __target.download_documents = download_documents;
        __target.document_max_size_bytes = document_max_size_bytes;
        if let Ok(__v) = ::serde_json::to_value(allowed_file_types) {
            if let Ok(t) = ::serde_json::from_value(__v) {
                __target.allowed_file_types = t;
            }
        }
    ...
    pub fn request_timeout_secs(&self) -> Option<u64> {
        self.0.request_timeout_secs.as_ref().and_then(|v| {
            ::serde_json::to_value(v)
                .ok()
                .and_then(|j| ::serde_json::from_value(j).ok())
        })
    ...
    pub fn document_max_size_bytes(&self) -> Option<u64> {
        self.0.document_max_size_bytes.as_ref().and_then(|v| {
            ::serde_json::to_value(v)
                .ok()
                .and_then(|j| ::serde_json::from_value(j).ok())
        })
    ...
    pub fn allowed_file_types(&self) -> Vec<String> {
        ::serde_json::to_value(&self.0.allowed_file_types)
            .ok()
            .and_then(|j| ::serde_json::from_value(j).ok())
            .unwrap_or_default()
    }
...
pub fn extract_bytes(
    ...
    crate::__alef_tokio_runtime().block_on(async {
        xberg::core::extractor::extract_bytes(&content, &mime_type, &config.0)
            .await
            .map_err(|e| e.to_string())
...
pub fn extract_file(
    ...
    crate::__alef_tokio_runtime().block_on(async {
        xberg::core::extractor::extract_file(std::path::PathBuf::from(path), mime_type.as_deref(), &config.0)
            .await
            .map_err(|e| e.to_string())
            .map(ExtractionResult)
    })
...
pub fn extract_file_sync(
    ...
    xberg::core::extractor::extract_file_sync(std::path::PathBuf::from(path), mime_type.as_deref(), &config.0)
        .map_err(|e| e.to_string())
        .map(ExtractionResult)
}
...
pub fn extract_bytes_sync(
    ...
    xberg::core::extractor::extract_bytes_sync(&content, &mime_type, &config.0)
        .map_err(|e| e.to_string())
        .map(ExtractionResult)
}
...
pub fn batch_extract_files_sync(
    ...
    xberg::core::extractor::batch_extract_files_sync(items.into_iter().map(|w| w.0).collect::<Vec<_>>(), &config.0)
        .map_err(|e| e.to_string())
...
pub fn batch_extract_bytes_sync(
    ...
    xberg::core::extractor::batch_extract_bytes_sync(items.into_iter().map(|w| w.0).collect::<Vec<_>>(), &config.0)
        .map_err(|e| e.to_string())
        .map(|v| v.into_iter().map(ExtractionResult).collect::<Vec<_>>())
}
...
pub fn batch_extract_files(
    ...
    crate::__alef_tokio_runtime().block_on(async {
        xberg::core::extractor::batch_extract_files(items.into_iter().map(|w| w.0).collect::<Vec<_>>(), &config.0)
            .await
            .map_err(|e| e.to_string())
            .map(|v| v.into_iter().map(ExtractionResult).collect::<Vec<_>>())
    })
...
pub fn batch_extract_bytes(
    ...
    crate::__alef_tokio_runtime().block_on(async {
        xberg::core::extractor::batch_extract_bytes(items.into_iter().map(|w| w.0).collect::<Vec<_>>(), &config.0)
            .await
            .map_err(|e| e.to_string())
            .map(|v| v.into_iter().map(ExtractionResult).collect::<Vec<_>>())
    })
