...
public struct UrlExtractionConfig: Codable, Sendable, Hashable {
    ...
    public let maxConcurrent: UInt32?
    ...
    public let requestTimeoutSecs: UInt64?
    ...
    public let documentMaxSizeBytes: UInt64?
    ...
    public let followDocumentUrls: Bool
    /// Maximum recursive document URL depth.
    public let documentUrlDepth: UInt32?
    ...
    public init(mode: UrlExtractionMode, maxDepth: UInt32? = nil, maxPages: UInt32? = nil, maxConcurrent: UInt32? = nil, stayOnDomain: Bool, allowSubdomains: Bool, includePaths: [String], excludePaths: [String], respectRobotsTxt: Bool, userAgent: String? = nil, requestTimeoutSecs: UInt64? = nil, downloadDocuments: Bool, documentMaxSizeBytes: UInt64? = nil, allowedFileTypes: [String], followDocumentUrls: Bool, documentUrlDepth: UInt32? = nil, documentUrlPattern: String? = nil, maxDocumentUrlsPerResult: UInt32? = nil, maxTotalUrls: UInt32? = nil, allowFileUris: Bool) {
        self.mode = mode
        ...
        self.documentMaxSizeBytes = documentMaxSizeBytes
        self.allowedFileTypes = allowedFileTypes
        self.followDocumentUrls = followDocumentUrls
        self.documentUrlDepth = documentUrlDepth
    ...
    private enum CodingKeys: String, CodingKey {
        ...
        case requestTimeoutSecs = "request_timeout_secs"
        case downloadDocuments = "download_documents"
        case documentMaxSizeBytes = "document_max_size_bytes"
        case allowedFileTypes = "allowed_file_types"
        case followDocumentUrls = "follow_document_urls"
        case documentUrlDepth = "document_url_depth"
    ...
    public init(from decoder: any Decoder) throws {
        ...
        self.maxDepth = try container.decodeIfPresent(UInt32.self, forKey: .maxDepth) ?? nil
        self.maxPages = try container.decodeIfPresent(UInt32.self, forKey: .maxPages) ?? nil
        self.maxConcurrent = try container.decodeIfPresent(UInt32.self, forKey: .maxConcurrent) ?? nil
        self.stayOnDomain = try container.decodeIfPresent(Bool.self, forKey: .stayOnDomain) ?? true
        self.allowSubdomains = try container.decodeIfPresent(Bool.self, forKey: .allowSubdomains) ?? true
        ...
        self.respectRobotsTxt = try container.decodeIfPresent(Bool.self, forKey: .respectRobotsTxt) ?? true
        self.userAgent = try container.decodeIfPresent(String.self, forKey: .userAgent) ?? nil
        self.requestTimeoutSecs = try container.decodeIfPresent(UInt64.self, forKey: .requestTimeoutSecs) ?? nil
        self.downloadDocuments = try container.decodeIfPresent(Bool.self, forKey: .downloadDocuments) ?? true
        self.documentMaxSizeBytes = try container.decodeIfPresent(UInt64.self, forKey: .documentMaxSizeBytes) ?? nil
        self.allowedFileTypes = try container.decodeIfPresent([String].self, forKey: .allowedFileTypes) ?? []
        self.followDocumentUrls = try container.decodeIfPresent(Bool.self, forKey: .followDocumentUrls) ?? false
        self.documentUrlDepth = try container.decodeIfPresent(UInt32.self, forKey: .documentUrlDepth) ?? nil
...
internal extension UrlExtractionConfig {
    init(_ rb: RustBridge.UrlExtractionConfigRef) throws {
        ...
        self.includePaths = rb.includePaths().map { $0.as_str().toString() }
        self.excludePaths = rb.excludePaths().map { $0.as_str().toString() }
        self.respectRobotsTxt = rb.respectRobotsTxt()
        self.userAgent = rb.userAgent()?.toString()
        self.requestTimeoutSecs = rb.requestTimeoutSecs()
        self.downloadDocuments = rb.downloadDocuments()
        self.documentMaxSizeBytes = rb.documentMaxSizeBytes()
        self.allowedFileTypes = rb.allowedFileTypes().map { $0.as_str().toString() }
        self.followDocumentUrls = rb.followDocumentUrls()
        self.documentUrlDepth = rb.documentUrlDepth()
    ...
    func intoRust() throws -> RustBridge.UrlExtractionConfig {
        let __includePaths = RustVec<RustString>()
        for __elem in self.includePaths { __includePaths.push(value: RustString(__elem)) }
        let __excludePaths = RustVec<RustString>()
        for __elem in self.excludePaths { __excludePaths.push(value: RustString(__elem)) }
        let __allowedFileTypes = RustVec<RustString>()
        for __elem in self.allowedFileTypes { __allowedFileTypes.push(value: RustString(__elem)) }
        return RustBridge.UrlExtractionConfig(try self.mode.intoRust(), self.maxDepth, self.maxPages, self.maxConcurrent, self.stayOnDomain, self.allowSubdomains, __includePaths, __excludePaths, self.respectRobotsTxt, self.userAgent.map(RustString.init), self.requestTimeoutSecs, self.downloadDocuments, self.documentMaxSizeBytes, __allowedFileTypes, self.followDocumentUrls, self.documentUrlDepth, self.documentUrlPattern.map(RustString.init), self.maxDocumentUrlsPerResult, self.maxTotalUrls, self.allowFileUris)
    }
}
