...
void* __swift_bridge__$UrlExtractionConfig$new(void* mode, struct __private__OptionU32 max_depth, struct __private__OptionU32 max_pages, struct __private__OptionU32 max_concurrent, bool stay_on_domain, bool allow_subdomains, void* include_paths, void* exclude_paths, bool respect_robots_txt, void* user_agent, struct __private__OptionU64 request_timeout_secs, bool download_documents, struct __private__OptionU64 document_max_size_bytes, void* allowed_file_types, bool follow_document_urls, struct __private__OptionU32 document_url_depth, void* document_url_pattern, struct __private__OptionU32 max_document_urls_per_result, struct __private__OptionU32 max_total_urls, bool allow_file_uris);
void* __swift_bridge__$UrlExtractionConfig$mode(void* self);
struct __private__OptionU32 __swift_bridge__$UrlExtractionConfig$max_depth(void* self);
struct __private__OptionU32 __swift_bridge__$UrlExtractionConfig$max_pages(void* self);
struct __private__OptionU32 __swift_bridge__$UrlExtractionConfig$max_concurrent(void* self);
bool __swift_bridge__$UrlExtractionConfig$stay_on_domain(void* self);
bool __swift_bridge__$UrlExtractionConfig$allow_subdomains(void* self);
void* __swift_bridge__$UrlExtractionConfig$include_paths(void* self);
void* __swift_bridge__$UrlExtractionConfig$exclude_paths(void* self);
bool __swift_bridge__$UrlExtractionConfig$respect_robots_txt(void* self);
void* __swift_bridge__$UrlExtractionConfig$user_agent(void* self);
struct __private__OptionU64 __swift_bridge__$UrlExtractionConfig$request_timeout_secs(void* self);
bool __swift_bridge__$UrlExtractionConfig$download_documents(void* self);
struct __private__OptionU64 __swift_bridge__$UrlExtractionConfig$document_max_size_bytes(void* self);
void* __swift_bridge__$UrlExtractionConfig$allowed_file_types(void* self);
bool __swift_bridge__$UrlExtractionConfig$follow_document_urls(void* self);
struct __private__OptionU32 __swift_bridge__$UrlExtractionConfig$document_url_depth(void* self);
