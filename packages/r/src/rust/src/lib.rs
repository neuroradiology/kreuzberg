...
#[allow(clippy::missing_errors_doc)]
#[extendr]
pub fn classify_text(text: String, config: &PageClassificationConfig) -> Result<Vec<ClassificationLabel>> {
    let config_core: kreuzberg::PageClassificationConfig = config.clone().into();
...
#[allow(clippy::missing_errors_doc)]
#[extendr]
pub fn rerank(query: String, documents: Vec<String>, config: &RerankerConfig) -> Result<Vec<RerankedDocument>> {
