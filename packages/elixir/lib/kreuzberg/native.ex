...
defmodule Kreuzberg.Native do
  ...
  * `mime_type` - The MIME type to look up
  ...
  `complete_text`.
  """
  def summarize_with_llm_async(_text, _llm_config, _max_tokens), do: :erlang.nif_error(:nif_not_loaded)
  ...
  * `custom_prompt` — Optional override for the default per-region prompt template.
  ...
  """
  def extract_region_with_vlm_usage_async(_image_bytes, _image_mime, _region_kind, _llm_config, _custom_prompt),
    do: :erlang.nif_error(:nif_not_loaded)
  ...
  * `source` — label used for the returned [`LlmUsage`] entry.
  ...
  """
  def complete_with_json_schema_async(_llm_config, _prompt, _schema_name, _schema, _source),
    do: :erlang.nif_error(:nif_not_loaded)
  ...
  """
  def complete_text_async(_llm_config, _prompt, _source), do: :erlang.nif_error(:nif_not_loaded)
