...
defmodule Kreuzberg do
  ...
  @doc "Run abstractive summarisation against the configured LLM."
  @spec summarize_with_llm_async(String.t(), keyword()) ::
          {:ok, String.t()} | {:error, atom, String.t()}
  def summarize_with_llm_async(text, opts \\ []) do
    Kreuzberg.Native.summarize_with_llm_async(
      text,
  ...
  @doc "Same as [`extract_region_with_vlm`], but also returns the [`LlmUsage`] data captured from the underlying VLM call."
  @spec extract_region_with_vlm_usage_async(binary(), String.t(), map(), keyword()) ::
          {:ok, String.t()} | {:error, atom, String.t()}
  def extract_region_with_vlm_usage_async(image_bytes, image_mime, region_kind, opts \\ []) do
    Kreuzberg.Native.extract_region_with_vlm_usage_async(
      image_bytes,
      image_mime,
      region_kind,
      Keyword.get(opts, :llm_config),
  ...
  @doc "Send a free-form prompt to the configured LLM with a JSON-schema response constraint and return the parsed JSON value plus captured usage."
  @spec complete_with_json_schema_async(
          String.t() | nil,
          String.t(),
          String.t(),
          String.t(),
  ...
  def complete_with_json_schema_async(llm_config \\ nil, prompt, schema_name, schema, source) do
    Kreuzberg.Native.complete_with_json_schema_async(llm_config, prompt, schema_name, schema, source)
  end

  @doc "Send a single user prompt to the configured LLM and return the response text along with the captured usage metadata."
  @spec complete_text_async(String.t() | nil, String.t(), String.t()) ::
          {:ok, String.t()} | {:error, atom, String.t()}
  def complete_text_async(llm_config \\ nil, prompt, source) do
    Kreuzberg.Native.complete_text_async(llm_config, prompt, source)
  end
