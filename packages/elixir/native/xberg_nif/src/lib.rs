...
impl UrlExtractionConfig {
    pub fn new(opts: std::collections::HashMap<String, rustler::Term>) -> Self {
        Self {
            ...
            stay_on_domain: opts.get("stay_on_domain").and_then(|t| t.decode().ok()).unwrap_or(true),
            ...
            request_timeout_secs: opts.get("request_timeout_secs").and_then(|t| t.decode().ok()),
            download_documents: opts
                .get("download_documents")
                .and_then(|t| t.decode().ok())
                .unwrap_or(true),
            document_max_size_bytes: opts.get("document_max_size_bytes").and_then(|t| t.decode().ok()),
            allowed_file_types: opts
    ...
    let result = std::panic::catch_unwind(std::panic::AssertUnwindSafe(|| {
        std::thread::Builder::new()
            ...
            .spawn(move || {
                ...
                let result = rt
                    .block_on(async {
                        xberg::core::extractor::extract_bytes(
                            &content,
                            &mime_type,
...
pub fn extract_bytes_sync(
    ...
    let config_core: Option<xberg::ExtractionConfig> = config
        ...
        .transpose()
        .map_err(|e| e.to_string())?;
    let result = xberg::core::extractor::extract_bytes_sync(
        content.as_slice(),
        &mime_type,
        config_core.as_ref().unwrap_or(&Default::default()),
    )
...
pub fn batch_extract_files_sync(
    ...
    let config_core: Option<xberg::ExtractionConfig> = config
        ...
        .transpose()
        .map_err(|e| e.to_string())?;
    let result = xberg::core::extractor::batch_extract_files_sync(
        items_core,
        config_core.as_ref().unwrap_or(&Default::default()),
    )
    .map_err(|e| e.to_string())?;
...
pub fn batch_extract_bytes_sync(
    ...
    let config_core: Option<xberg::ExtractionConfig> = config
        ...
        .transpose()
        .map_err(|e| e.to_string())?;
    let result = xberg::core::extractor::batch_extract_bytes_sync(
        items_core,
        config_core.as_ref().unwrap_or(&Default::default()),
    )
    .map_err(|e| e.to_string())?;
