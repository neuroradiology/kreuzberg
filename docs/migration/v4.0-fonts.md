...
=== "Rust"
    ...
    let result = xberg::extract("document.pdf", &config)?;
    ...
    let result2 = xberg::extract("document2.pdf", &new_config)?;
...
=== "Python"
    ...
    result = extract("document.pdf", config)
    ...
    result2 = extract("document2.pdf", new_config)
    # Warning logged: "Font config already initialized"
    ```
...
=== "Ruby"
    ...
    result = Xberg.extract('document.pdf', config)
    ...
    result2 = Xberg.extract('document2.pdf', new_config)
    # Warning logged: "Font config already initialized"
    ```
