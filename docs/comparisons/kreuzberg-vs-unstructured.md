...
- **Kreuzberg** -- Polyglot SDKs for Python, TypeScript, Rust, Go, Java/Kotlin JVM, Kotlin Android, C#, Ruby, PHP, Elixir, R, Dart, Swift, Zig, C, and Wasm. Each native binding calls directly into the Rust core. Also runs in the browser via Wasm.
