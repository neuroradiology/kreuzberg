...
test "ocr_image_png" {
    ...
    const _result_json = try xberg.extract("{\"config\":{},\"data\":\"images/test_hello_world.png\",\"mime_type\":\"image/png\"}", "{}");
...
test "smoke_docx_basic" {
    ...
    const _result_json = try xberg.extract("{\"config\":{},\"mime_type\":\"application/vnd.openxmlformats-officedocument.wordprocessingml.document\",\"path\":\"docx/fake.docx\"}", "{}");
    defer std.heap.c_allocator.free(_result_json);
    var _parsed = try std.json.parseFromSlice(std.json.Value, allocator, _result_json, .{});
    defer _parsed.deinit();
    const result = &_parsed.value;
...
test "smoke_html_basic" {
    ...
    const _result_json = try xberg.extract("{\"config\":{},\"mime_type\":\"text/html\",\"path\":\"html/simple_table.html\"}", "{}");
    defer std.heap.c_allocator.free(_result_json);
    var _parsed = try std.json.parseFromSlice(std.json.Value, allocator, _result_json, .{});
    defer _parsed.deinit();
    const result = &_parsed.value;
...
test "smoke_image_png" {
    ...
    const _result_json = try xberg.extract("{\"config\":{\"disable_ocr\":true},\"media_type\":\"image/png\",\"path\":\"images/sample.png\"}", "{\"disable_ocr\":true}");
    defer std.heap.c_allocator.free(_result_json);
    var _parsed = try std.json.parseFromSlice(std.json.Value, allocator, _result_json, .{});
    defer _parsed.deinit();
    const result = &_parsed.value;
...
test "smoke_json_basic" {
    ...
    const _result_json = try xberg.extract("{\"config\":{},\"mime_type\":\"application/json\",\"path\":\"json/simple.json\"}", "{}");
    defer std.heap.c_allocator.free(_result_json);
    var _parsed = try std.json.parseFromSlice(std.json.Value, allocator, _result_json, .{});
    defer _parsed.deinit();
    const result = &_parsed.value;
...
test "smoke_pdf_basic" {
    ...
    const _result_json = try xberg.extract("{\"config\":{},\"mime_type\":\"application/pdf\",\"path\":\"pdf/fake_memo.pdf\"}", "{}");
    defer std.heap.c_allocator.free(_result_json);
    var _parsed = try std.json.parseFromSlice(std.json.Value, allocator, _result_json, .{});
    defer _parsed.deinit();
    const result = &_parsed.value;
...
test "smoke_txt_basic" {
    ...
    const _result_json = try xberg.extract("{\"config\":{},\"mime_type\":\"text/plain\",\"path\":\"text/report.txt\"}", "{}");
    defer std.heap.c_allocator.free(_result_json);
    var _parsed = try std.json.parseFromSlice(std.json.Value, allocator, _result_json, .{});
    defer _parsed.deinit();
    const result = &_parsed.value;
...
test "smoke_xlsx_basic" {
    ...
    const _result_json = try xberg.extract("{\"config\":{},\"mime_type\":\"application/vnd.openxmlformats-officedocument.spreadsheetml.sheet\",\"path\":\"xlsx/stanley_cups.xlsx\"}", "{}");
    defer std.heap.c_allocator.free(_result_json);
    var _parsed = try std.json.parseFromSlice(std.json.Value, allocator, _result_json, .{});
    defer _parsed.deinit();
    const result = &_parsed.value;
