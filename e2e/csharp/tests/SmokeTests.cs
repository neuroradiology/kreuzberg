...
namespace Xberg
{
    ...
    public class SmokeTests
    {
        ...
        public async Task Test_OcrImagePng()
        {
            ...
            var result = await XbergConverter.ExtractAsync(new ExtractionConfig { Config = "{}", Data = "images/test_hello_world.png", MimeType = "image/png" }, new ExtractionConfig());
    ...
    Assert.True(result.Content.ToString().Contains("Hello") || result.Content.ToString().Contains("World") || result.Content.ToString().Contains("hello") || result.Content.ToString().Contains("world"), "expected to contain at least one of the specified values");
        ...
        public async Task Test_SmokeDocxBasic()
        {
            ...
            var result = await XbergConverter.ExtractAsync(new ExtractionConfig { Config = "{}", MimeType = "application/vnd.openxmlformats-officedocument.wordprocessingml.document", Path = "docx/fake.docx" }, new ExtractionConfig());
    ...
    Assert.True(result.Content.ToString().Contains("Lorem") || result.Content.ToString().Contains("ipsum") || result.Content.ToString().Contains("document") || result.Content.ToString().Contains("text"), "expected to contain at least one of the specified values");
        ...
        public async Task Test_SmokeHtmlBasic()
        {
            ...
            var result = await XbergConverter.ExtractAsync(new ExtractionConfig { Config = "{}", MimeType = "text/html", Path = "html/simple_table.html" }, new ExtractionConfig());
    ...
    Assert.True(result.Content.ToString().Contains("Sample Data Table") || result.Content.ToString().Contains("Laptop") || result.Content.ToString().Contains("Electronics") || result.Content.ToString().Contains("Product"), "expected to contain at least one of the specified values");
        ...
        public async Task Test_SmokeImagePng()
        {
            ...
            var result = await XbergConverter.ExtractAsync(new ExtractionConfig { Config = "{\"disable_ocr\":true}", MediaType = "image/png", Path = "images/sample.png" }, new ExtractionConfig { DisableOcr = true });
    Assert.Equal("image/png", result.MimeType!.Trim());
        ...
        public async Task Test_SmokeJsonBasic()
        {
            ...
            var result = await XbergConverter.ExtractAsync(new ExtractionConfig { Config = "{}", MimeType = "application/json", Path = "json/simple.json" }, new ExtractionConfig());
    ...
    Assert.True(result.Content.Length >= 5, "expected length >= 5");
        ...
        public async Task Test_SmokePdfBasic()
        {
            ...
            var result = await XbergConverter.ExtractAsync(new ExtractionConfig { Config = "{}", MimeType = "application/pdf", Path = "pdf/fake_memo.pdf" }, new ExtractionConfig());
    ...
    Assert.True(result.Content.ToString().Contains("May 5, 2023") || result.Content.ToString().Contains("To Whom it May Concern"), "expected to contain at least one of the specified values");
        ...
        public async Task Test_SmokeTxtBasic()
        {
            ...
            var result = await XbergConverter.ExtractAsync(new ExtractionConfig { Config = "{}", MimeType = "text/plain", Path = "text/report.txt" }, new ExtractionConfig());
    ...
    Assert.True(result.Content.Length >= 5, "expected length >= 5");
        ...
        public async Task Test_SmokeXlsxBasic()
        {
            ...
            var result = await XbergConverter.ExtractAsync(new ExtractionConfig { Config = "{}", MimeType = "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", Path = "xlsx/stanley_cups.xlsx" }, new ExtractionConfig());
