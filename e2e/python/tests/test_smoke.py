...
async def test_ocr_image_png() -> None:
    ...
    input = ExtractionConfig(config={}, data="images/test_hello_world.png", mime_type="image/png")
...
async def test_smoke_docx_basic() -> None:
    ...
    input = ExtractionConfig(config={}, mime_type="application/vnd.openxmlformats-officedocument.wordprocessingml.document", path="docx/fake.docx")
    config = ExtractionConfig()
...
async def test_smoke_html_basic() -> None:
    ...
    input = ExtractionConfig(config={}, mime_type="text/html", path="html/simple_table.html")
    config = ExtractionConfig()
...
async def test_smoke_image_png() -> None:
    ...
    input = ExtractionConfig(config={"disable_ocr": True}, media_type="image/png", path="images/sample.png")
...
async def test_smoke_json_basic() -> None:
    ...
    input = ExtractionConfig(config={}, mime_type="application/json", path="json/simple.json")
    config = ExtractionConfig()
...
async def test_smoke_pdf_basic() -> None:
    ...
    input = ExtractionConfig(config={}, mime_type="application/pdf", path="pdf/fake_memo.pdf")
    config = ExtractionConfig()
...
async def test_smoke_txt_basic() -> None:
    ...
    input = ExtractionConfig(config={}, mime_type="text/plain", path="text/report.txt")
    config = ExtractionConfig()
...
async def test_smoke_xlsx_basic() -> None:
    ...
    input = ExtractionConfig(config={}, mime_type="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", path="xlsx/stanley_cups.xlsx")
    config = ExtractionConfig()
