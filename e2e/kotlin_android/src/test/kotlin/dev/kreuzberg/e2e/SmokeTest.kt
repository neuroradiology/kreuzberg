...
class SmokeTest {
    ...
    fun testSmokeXlsxBasic() = runBlocking {
        ...
        assertTrue(result.metadata.format?.excel?.sheetNames.orEmpty().toString().lowercase().contains("Stanley Cups".toString().lowercase()), "expected to contain: " + "Stanley Cups")
    }
