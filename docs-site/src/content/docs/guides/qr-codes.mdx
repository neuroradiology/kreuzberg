...
- [`ExtractedImage`](/reference/types/) — type reference
- [VLM Image Captions](/guides/image-captions/) — sibling per-image enrichment
- [Configuration Reference](/reference/configuration/#extractionconfig) — config field reference
