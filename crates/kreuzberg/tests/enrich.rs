...
use kreuzberg::{EnrichedResult, EnrichmentConfig, enrich};
...
async fn enrich_captioning_empty_images_yields_empty_vec() {
    ...
    use kreuzberg::enrich::CaptioningEnrichmentConfig;
...
async fn enrich_classification_leaves_other_stages_none() {
    ...
    use kreuzberg::enrich::ClassificationEnrichmentConfig;
...
mod stub_ner {
    ...
    use kreuzberg::types::entity::{Entity, EntityCategory};
...
async fn enrich_ner_with_stub_backend_populates_entities() {
    ...
    use kreuzberg::enrich::NerEnrichmentConfig;
...
async fn enrich_transcription_returns_not_implemented_error() {
    use kreuzberg::core::config::TranscriptionConfig;
