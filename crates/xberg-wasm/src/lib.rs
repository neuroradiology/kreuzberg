...
impl WasmUrlExtractionConfig {
    ...
    pub fn new(
        ...
        allowedFileTypes: Option<Vec<String>>,
        ...
        requestTimeoutSecs: Option<u64>,
        documentMaxSizeBytes: Option<u64>,
        ...
        WasmUrlExtractionConfig {
            ...
            stay_on_domain: stayOnDomain.unwrap_or(true),
            allow_subdomains: allowSubdomains.unwrap_or(true),
            include_paths: includePaths.unwrap_or_default(),
            exclude_paths: excludePaths.unwrap_or_default(),
            respect_robots_txt: respectRobotsTxt.unwrap_or(true),
            ...
            allowed_file_types: allowedFileTypes.unwrap_or_default(),
    ...
    pub fn set_max_depth(&mut self, value: Option<u32>) {
    ...
    pub fn set_max_pages(&mut self, value: Option<u32>) {
    ...
    pub fn set_max_concurrent(&mut self, value: Option<u32>) {
    ...
    #[wasm_bindgen(getter, js_name = "requestTimeoutSecs")]
    pub fn request_timeout_secs(&self) -> Option<u64> {
        self.request_timeout_secs
    }

    #[wasm_bindgen(setter, js_name = "requestTimeoutSecs")]
    pub fn set_request_timeout_secs(&mut self, value: Option<u64>) {
    ...
    #[wasm_bindgen(getter, js_name = "documentMaxSizeBytes")]
    pub fn document_max_size_bytes(&self) -> Option<u64> {
        self.document_max_size_bytes
    }

    #[wasm_bindgen(setter, js_name = "documentMaxSizeBytes")]
    pub fn set_document_max_size_bytes(&mut self, value: Option<u64>) {
        self.document_max_size_bytes = value;
    }

    #[wasm_bindgen(getter, js_name = "allowedFileTypes")]
    pub fn allowed_file_types(&self) -> Vec<String> {
        self.allowed_file_types.clone()
    }

    #[wasm_bindgen(setter, js_name = "allowedFileTypes")]
    pub fn set_allowed_file_types(&mut self, value: Vec<String>) {
...
pub async fn extract_bytes(
    ...
    let result = xberg::core::extractor::extract_bytes(&content, &mime_type, &config_core)
        .await
        .map_err(|e| JsValue::from_str(&e.to_string()))?;
...
pub fn extract_bytes_sync(
    ...
    let result = xberg::core::extractor::extract_bytes_sync(&content, &mime_type, &config_core)
        .map_err(|e| JsValue::from_str(&e.to_string()))?;
    Ok(result.into())
}
...
pub fn batch_extract_bytes_sync(items: Vec<String>, config: JsValue) -> Result<Vec<WasmExtractionResult>, JsValue> {
    ...
    let config_core: xberg::ExtractionConfig = config_input.into();
    let result = xberg::core::extractor::batch_extract_bytes_sync(items_core, &config_core)
        .map_err(|e| JsValue::from_str(&e.to_string()))?;
...
impl From<WasmUrlExtractionConfig> for xberg::UrlExtractionConfig {
    fn from(val: WasmUrlExtractionConfig) -> Self {
        Self {
            ...
            request_timeout_secs: val.request_timeout_secs,
            download_documents: val.download_documents,
            document_max_size_bytes: val.document_max_size_bytes,
