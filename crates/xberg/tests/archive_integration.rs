...
async fn test_zip_basic_extraction() {
    ...
    let result = extract_bytes_result(&zip_bytes, "application/zip", &config)
        .await
...
async fn test_tar_extraction() {
    ...
    let result = extract_bytes_result(&tar_bytes, "application/x-tar", &config)
        .await
...
async fn test_tar_gz_extraction() {
    ...
    let result2 = extract_bytes_result(&tar_bytes, "application/tar", &config)
        .await
...
async fn test_nested_archive() {
    ...
    let result = extract_bytes_result(&outer_zip_bytes, "application/zip", &config)
        .await
        .expect("Should extract nested ZIP");
...
async fn test_password_protected_archive() {
    ...
    let result = extract_bytes_result(&invalid_zip, "application/zip", &config).await;
...
async fn test_corrupted_archive() {
    ...
    let result = extract_bytes_result(&corrupted_tar, "application/x-tar", &config).await;
    assert!(
...
fn test_archive_extraction_sync() {
    ...
    let zip_bytes = create_simple_zip();
    let result = extract_bytes_result_blocking(&zip_bytes, "application/zip", &config)
