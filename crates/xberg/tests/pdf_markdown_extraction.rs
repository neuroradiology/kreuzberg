...
fn test_pdf_markdown_extraction_produces_structured_output() {
    ...
    let result = extract_file_result_blocking(&path, None, &config).expect("Should extract PDF as markdown");
...
fn test_pdf_plain_extraction_unchanged() {
    ...
    let result = extract_file_result_blocking(&path, None, &config).expect("Should extract PDF as plain text");
...
fn test_pdf_markdown_vs_plain_has_more_structure() {
    ...
    let plain_result = extract_file_result_blocking(&path, None, &plain_config).expect("Plain extraction failed");
    ...
    let md_result = extract_file_result_blocking(&path, None, &md_config).expect("Markdown extraction failed");
...
fn test_pdf_markdown_heuristic_fallback_preserves_paragraphs() {
    ...
    let result = extract_file_result_blocking(&path, None, &config).expect("Should extract PDF");
