...
fn test_page_markers_inserted_when_enabled() {
    ...
    let result =
        extract_file_result_blocking(&file_path, None, &config).expect("Failed to extract PDF with page markers");
...
fn test_custom_marker_format() {
    ...
    let result =
        extract_file_result_blocking(&file_path, None, &config).expect("Failed to extract PDF with custom markers");
...
fn test_markers_and_extract_pages_together() {
    ...
    let result =
        extract_file_result_blocking(&file_path, None, &config).expect("Failed to extract PDF with both features");
...
fn test_no_markers_when_disabled() {
    ...
    let result =
        extract_file_result_blocking(&file_path, None, &config).expect("Failed to extract PDF without markers");
...
fn test_marker_appears_before_content() {
    ...
    let result = extract_file_result_blocking(&file_path, None, &config).expect("Failed to extract PDF with markers");
...
fn test_multi_page_markers() {
    ...
    let result = extract_file_result_blocking(&file_path, None, &config).expect("Failed to extract PDF");
...
fn test_page_markers_in_markdown_output() {
    ...
    let result = extract_file_result_blocking(&file_path, None, &config).expect("Failed to extract PDF as markdown");
...
fn test_page_markers_in_djot_output() {
    ...
    let result = extract_file_result_blocking(&file_path, None, &config).expect("Failed to extract PDF as djot");
