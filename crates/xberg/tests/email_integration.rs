...
This is the email body content.";
    ...
    let result = extract_bytes_result(eml_content, "message/rfc822", &config)
        .await
...
async fn test_msg_file_extraction() {
    ...
    let result = extract_bytes_result(invalid_msg, "application/vnd.ms-outlook", &config).await;
...
async fn test_malformed_email() {
    ...
    let result = extract_bytes_result(malformed_eml, "message/rfc822", &config).await;
...
async fn test_msg_basic_extraction() {
    ...
    let result = extract_bytes_result(&data, "application/vnd.ms-outlook", &config)
        .await
...
async fn test_msg_invalid_data() {
    let config = ExtractionConfig::default();
    let result = extract_bytes_result(b"not a valid MSG", "application/vnd.ms-outlook", &config).await;
...
async fn test_msg_bad_outlook() {
    ...
    let result = extract_bytes_result(&data, "application/vnd.ms-outlook", &config).await;
