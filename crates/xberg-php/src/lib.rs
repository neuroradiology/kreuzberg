...
pub struct UrlExtractionConfig {
    ...
    #[serde(default = "crate::serde_defaults::url_extraction_config_stay_on_domain")]
    pub stay_on_domain: bool,
    /// Allow subdomains when staying on domain.
    #[php(prop, name = "allowSubdomains")]
    #[serde(default = "crate::serde_defaults::url_extraction_config_allow_subdomains")]
    ...
    #[serde(default = "crate::serde_defaults::url_extraction_config_respect_robots_txt")]
    pub respect_robots_txt: bool,
    /// Custom user agent.
    #[php(prop, name = "userAgent")]
    pub user_agent: Option<String>,
    /// Per-request timeout in seconds.
    #[php(prop, name = "requestTimeoutSecs")]
    pub request_timeout_secs: Option<i64>,
    /// Download non-HTML documents discovered during crawl.
    #[php(prop, name = "downloadDocuments")]
    #[serde(default = "crate::serde_defaults::url_extraction_config_download_documents")]
    pub download_documents: bool,
    /// Maximum size for downloaded documents.
    #[php(prop, name = "documentMaxSizeBytes")]
    pub document_max_size_bytes: Option<i64>,
    /// MIME allowlist for downloaded documents.
    #[php(prop, name = "allowedFileTypes")]
    pub allowed_file_types: Vec<String>,
    /// Follow URLs discovered inside extracted documents.
    #[php(prop, name = "followDocumentUrls")]
    #[serde(default = "crate::serde_defaults::url_extraction_config_follow_document_urls")]
...
impl UrlExtractionConfig {
    ...
    pub fn new(
        ...
        requestTimeoutSecs: Option<i64>,
        downloadDocuments: bool,
        documentMaxSizeBytes: Option<i64>,
        ...
        Self {
            ...
            document_max_size_bytes: documentMaxSizeBytes,
    ...
    pub fn get_request_timeout_secs(&self) -> Option<i64> {
        self.request_timeout_secs.clone()
    }
    ...
    pub fn get_document_max_size_bytes(&self) -> Option<i64> {
        self.document_max_size_bytes.clone()
    }

    pub fn get_allowed_file_types(&self) -> Vec<String> {
        self.allowed_file_types.clone()
    }
...
impl XbergApi {
    ...
    pub fn extract_bytes(
        ...
        WORKER_RUNTIME.block_on(async {
            let result =
                xberg::core::extractor::extract_bytes(&content.0[..], &mimeType, &config_core.unwrap_or_default())
                    .await
                    .map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
            Ok(result.into())
        })
    ...
    pub fn extract_file(
        ...
        let config_core: Option<xberg::ExtractionConfig> = config.map(|v| v.clone().into());
        WORKER_RUNTIME.block_on(async {
            let result = xberg::core::extractor::extract_file(
    ...
    pub fn extract_file_sync(
        ...
        let config_core: Option<xberg::ExtractionConfig> = config.map(|v| v.clone().into());
        let result = xberg::core::extractor::extract_file_sync(
            std::path::PathBuf::from(path),
            mimeType.as_deref(),
            &config_core.unwrap_or_default(),
        )
    ...
    pub fn extract_bytes_sync(
        ...
        let config_core: Option<xberg::ExtractionConfig> = config.map(|v| v.clone().into());
        let result =
            xberg::core::extractor::extract_bytes_sync(&content.0[..], &mimeType, &config_core.unwrap_or_default())
                .map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
        Ok(result.into())
    }
    ...
    pub fn batch_extract_files_sync(
        ...
        let config_core: Option<xberg::ExtractionConfig> = config.map(|v| v.clone().into());
        let result = xberg::core::extractor::batch_extract_files_sync(items_core, &config_core.unwrap_or_default())
            .map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
        Ok(result.into_iter().map(Into::into).collect())
    }
    ...
    pub fn batch_extract_bytes_sync(
        ...
        let config_core: Option<xberg::ExtractionConfig> = config.map(|v| v.clone().into());
        let result = xberg::core::extractor::batch_extract_bytes_sync(items_core, &config_core.unwrap_or_default())
            .map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
        Ok(result.into_iter().map(Into::into).collect())
    }
    ...
    pub fn batch_extract_files(
        ...
        let config_core: Option<xberg::ExtractionConfig> = config.map(|v| v.clone().into());
        WORKER_RUNTIME.block_on(async {
            let result = xberg::core::extractor::batch_extract_files(items_core, &config_core.unwrap_or_default())
                .await
                .map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
            Ok(result.into_iter().map(Into::into).collect())
        })
    ...
    pub fn batch_extract_bytes(
        ...
        let config_core: Option<xberg::ExtractionConfig> = config.map(|v| v.clone().into());
        WORKER_RUNTIME.block_on(async {
            let result = xberg::core::extractor::batch_extract_bytes(items_core, &config_core.unwrap_or_default())
                .await
                .map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
            Ok(result.into_iter().map(Into::into).collect())
        })
...
impl From<UrlExtractionConfig> for xberg::UrlExtractionConfig {
    fn from(val: UrlExtractionConfig) -> Self {
        Self {
            ...
            request_timeout_secs: val.request_timeout_secs.map(|v| v as u64),
            download_documents: val.download_documents,
            document_max_size_bytes: val.document_max_size_bytes.map(|v| v as u64),
            allowed_file_types: val.allowed_file_types.into_iter().collect(),
...
impl From<xberg::UrlExtractionConfig> for UrlExtractionConfig {
    fn from(val: xberg::UrlExtractionConfig) -> Self {
        Self {
            ...
            request_timeout_secs: val.request_timeout_secs.map(|v| v as i64),
            download_documents: val.download_documents,
            document_max_size_bytes: val.document_max_size_bytes.map(|v| v as i64),
            allowed_file_types: val.allowed_file_types.into_iter().collect(),
            follow_document_urls: val.follow_document_urls,
            document_url_depth: val.document_url_depth,
...
mod serde_defaults {
    ...
    pub fn url_extraction_config_stay_on_domain() -> bool {
        true
    }
    pub fn url_extraction_config_allow_subdomains() -> bool {
        true
    }
    pub fn url_extraction_config_respect_robots_txt() -> bool {
        true
    }
    pub fn url_extraction_config_download_documents() -> bool {
        true
    }
    pub fn url_extraction_config_follow_document_urls() -> bool {
        false
    }
