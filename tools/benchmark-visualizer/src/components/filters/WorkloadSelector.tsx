	...
	return (
		<Card data-testid={testId}>
			<CardHeader>
				...
				<CardDescription>Select your workload to view performance comparisons across frameworks</CardDescription>
			</CardHeader>
			<CardContent>
				<div className="space-y-6">
					...
					<div>
						...
						<div className="grid gap-4 md:grid-cols-2">
							...
							<div className="flex flex-col gap-2">
								...
								<p className="text-xs text-muted-foreground">Affects which metrics are emphasized</p>
							</div>
							...
							<div className="flex flex-col gap-2">
								...
								<p className="text-xs text-muted-foreground">Choose your deployment target</p>
							</div>
						</div>
					</div>
					...
					<div className="flex gap-2 pt-2">
						<Button onClick={handleViewRecommendations} disabled={!isValid} data-testid={`${testId}-submit`}>
					...
					<p className="text-xs text-muted-foreground">
						Select a file type and OCR mode to view performance comparisons. Optional selections help refine the
						recommendations.
					</p>
				</div>
			</CardContent>
