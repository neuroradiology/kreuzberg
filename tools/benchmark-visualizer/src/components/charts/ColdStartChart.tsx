			...
			<CardContent>
				<ResponsiveContainer width="100%" height={400}>
					...
					>
						...
						/>
						<Bar dataKey="p50" fill={PERCENTILE_COLORS.p50} data-testid="bar-cold-start-p50" name="p50" />
						<Bar dataKey="p95" fill={PERCENTILE_COLORS.p95} data-testid="bar-cold-start-p95" name="p95" />
						<Bar dataKey="p99" fill={PERCENTILE_COLORS.p99} data-testid="bar-cold-start-p99" name="p99" />
					</BarChart>
				</ResponsiveContainer>
